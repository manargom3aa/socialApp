...
exports.createChattingGroup = exports.sendGroupMessageSchema = exports.sendMessageSchema = exports.getChattingGroup = exports.getChat = void 0;
...
exports.sendMessageSchema = zod_1.z.strictObject({
    content: zod_1.z.string().min(1, "Message cannot be empty").max(5000),
    sendTo: zod_1.z.string().length(24, "Invalid user ID"),
});
exports.sendGroupMessageSchema = zod_1.z.strictObject({
    content: zod_1.z.string().min(1, "Message cannot be empty").max(5000),
    groupId: zod_1.z.string().length(24, "Invalid group ID"),
});
